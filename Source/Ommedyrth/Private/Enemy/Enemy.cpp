...
void AEnemy::SpawnSoul()
{
	...
	{
		ASoul* SpawnedSoul = World->SpawnActor<ASoul>(SoulClass, GetActorLocation() + FVector(0.f, 0.f, 100.f), GetActorRotation());
		if (SpawnedSoul)
		{
...
void AEnemy::SpawnPotion()
{
	...
	if (World && PotionClasses.Num() > 0)
	{
		...
		if (Chance >= 0.5f)
		{
			...
			World->SpawnActor<APotion>(PotionClasses[Selection], GetActorLocation() + FVector(0.f, 75.f, -50.f), GetActorRotation());
		}
	}
}
...
void AEnemy::HandleDamage(float DamageAmount)
{
	...
	{
		HealthBarWidget->SetHealth(Attributes->GetHealthPercent());
	}
}
...
void AEnemy::SpawnDefaultWeapon()
{
	...
	if (World && WeaponClass)
	{
		...
		DefaultWeapon->DisableEquipSound();
